...
require (
	...
	github.com/mattermost/mattermost/server/public v0.1.22-0.20251212204551-54f2e9b4afd5
	github.com/mattermost/mattermost/server/v8 v8.0.0-20251212204551-54f2e9b4afd5
