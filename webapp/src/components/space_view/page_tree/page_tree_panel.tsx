        ...
        <div className={styles.panel}>
            ...
            >
                <FormattedMessage
                    ...
                    defaultMessage='Use the arrow keys to move through pages. Hold Alt with an arrow key to move the selected page up, down, in, or out. Press Tab to reach the actions menu for the selected page.'
                />
            </p>
