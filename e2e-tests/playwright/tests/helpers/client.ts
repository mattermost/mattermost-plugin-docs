...
// Carries the HTTP status so callers can branch on it (e.g. a 501 feature gate)
...
// A short unique token for naming seeded entities so repeat runs don't collide.
